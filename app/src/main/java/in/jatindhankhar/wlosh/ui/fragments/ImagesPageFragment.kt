...
import `in`.jatindhankhar.wlosh.utils.Constants.ACCESS_KEY_PREF
...
class ImagesFragment : Fragment(), ImageItemClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        mPageCategory.let {
            view.loading_animation.visibility = View.VISIBLE
    ...
    private fun initUnSplashClient(accesKey: String): UnSplashClient {
        return object : UnSplashClient(accesKey) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Launch client only if parent activity is not null
        activity?.applicationContext?.let {
            mUnSplashClient = initUnSplashClient(Essentials.prefRead(it, ACCESS_KEY_PREF))
        }
